...
/***/ function(module, exports) {
	...
	var _ref4 = [];
	var _ref4$ = _ref4[0];
	var foo3 = _ref4$ === undefined ? true : _ref4$;
	
	console.log(foo3); // true
	var _ref5 = ['a'];
	var x3 = _ref5[0];
	var _ref5$ = _ref5[1];
	var y3 = _ref5$ === undefined ? 'b' : _ref5$;
	
	console.log(x3 + ',' + y3); // a,b
	var x4 = 'a';
	var _undefined = undefined;
	var y4 = _undefined === undefined ? 'b' : _undefined;
	
	console.log(x4 + ',' + y4); // a,b
	var x5 = 'a';
	var _ref6 = null;
	var y5 = _ref6 === undefined ? 'b' : _ref6;
	...
	var _ = 1;
	var x6 = _ === undefined ? func1() : _; // 默认的函数不会执行。
	// 等价于 ======>
	// let x6;
	// if ([1][0] === undefined) {
	//     x6 = func1();
	...
	var _ref7 = [];
	var _ref7$ = _ref7[0];
	var xx1 = _ref7$ === undefined ? 1 : _ref7$;
	var _ref7$2 = _ref7[1];
	var yy1 = _ref7$2 === undefined ? xx1 : _ref7$2;
	
	console.log(xx1 + ',' + yy1); // 1,1
	var _ref8 = [2];
	var _ref8$ = _ref8[0];
	var xx2 = _ref8$ === undefined ? 1 : _ref8$;
	var _ref8$2 = _ref8[1];
	var yy2 = _ref8$2 === undefined ? xx2 : _ref8$2;
	
	console.log(xx2 + ',' + yy2); // 2,2
	var _2 = 1;
	var xx3 = _2 === undefined ? 1 : _2;
	var _3 = 2;
	var yy3 = _3 === undefined ? xx3 : _3;
	
	console.log(xx3 + ',' + yy3); // 1,2
	var _ref9 = [];
	var _ref9$ = _ref9[0];
	var xx4 = _ref9$ === undefined ? yy4 : _ref9$;
	var _ref9$2 = _ref9[1];
	var yy4 = _ref9$2 === undefined ? 1 : _ref9$2;

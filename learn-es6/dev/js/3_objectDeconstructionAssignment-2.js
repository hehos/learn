...
/***/ function(module, exports) {
	...
	var baz = _foo2$bar.baz;
	
	console.log(baz); // undefined
	
	var _foo3$bar = { foo3: 'aaa', bar3: 'bbb' };
	var baz2 = _foo3$bar.foo3;
	...
	var ele = _insetType$insetK[0];
	var insetK2 = _insetType$insetK[1].insetK2;
	...
	var arr1 = [1, 2, 3];
	var first = arr1[0];
	var last = arr1[arr1.length - 1]; // 方括号这种写法，属于“属性名表达式”
	
	console.log(first + ',' + last); // 1,3
	
	// 数值和布尔值的解构赋值
	var _ = 123;
	var strintVar = _.toString;
	
	console.log(strintVar === Number.prototype.toString); // true
	var _true = true;
	var booleVar = _true.toString;
